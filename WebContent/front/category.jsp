	...
	<div class="g-bd f-cb">
		<div class="g-mn">
			<div class="m-tabs line">
					<h3 class="tag-name">
					<s:if test="total>0">
						<s:property value="#request.books[0].category.oneCategory" /></s:if>
					</h3>
				<div class="desc">
					<ul>
						...
						<li class="curr"><a
							href="front/book/sort?categoryId=<s:property value="categoryId" />&page=1&limit=10">销量▼</a></li>
						<li><a href="">价格▲</a></li>
						<li><a href="">评分▼</a></li>
					</ul>
				</div>
			...
			<s:if test="#request.pageCount!=0">
				<div class="m-page m-page-sr m-page-sm">
					<a
						href="front/book/findCategoryBook?categoryId=<s:property value="categoryId" />&page=1&limit=10"
					...
					<s:else>
						<a
							href="front/book/findCategoryBook?categoryId=<s:property value="categoryId" />&page=<s:property value="page-1"/>&limit=10"
							class="first pageprv"><span class="pagearr">&lt;</span>上一页</a>
					</s:else>
					<s:if test="page>2">
						<a
							href="front/book/findCategoryBook?categoryId=<s:property value="categoryId" />&page=<s:property value="page-2"/>&limit=10"><s:property
								value="page-2" /></a>
					</s:if>
					<s:if test="page>=2">
						<a
							href="front/book/findCategoryBook?categoryId=<s:property value="categoryId" />&page=<s:property value="page-1"/>&limit=10"><s:property
								value="page-1" /></a>
					</s:if>
					<a class="z-crt"
						href="front/book/findCategoryBook?categoryId=<s:property value="categoryId" />&page=<s:property value="page"/>&limit=10"><s:property
							value="page" /></a>
					...
					<s:if test="page<pageCount-1">
						<a
							href="front/book/getCategoryBook?categoryId=<s:property value="categoryId" />&page=<s:property value="page+2"/>&limit=10"><s:property
								value="page+2" /></a>
					</s:if>
					<s:if test="page>=pageCount">
					...
					<a
						href="front/book/findCategoryBook?categoryId=<s:property value="categoryId" />&page=<s:property value="pageCount"/>&limit=10"
